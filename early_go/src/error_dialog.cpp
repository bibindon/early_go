...
void show_error_dialog(const HINSTANCE &hinstance, const std::exception &e)
{
    ...
    DialogBox(hinstance, MAKEINTRESOURCE(IDD_DIALOG1), nullptr, error_dialog_procedure);
}

INT_PTR CALLBACK error_dialog_procedure(HWND hwnd, UINT msg, WPARAM wparam, LPARAM)
{
