...
public:
    ...
    void add_message_in_frame(const std::string &, const std::string &, const std::string &);
    void show_HP_info();
    void remove_HP_info();
...
private:
    ...
    void create_round_rect(LPDIRECT3DTEXTURE9 &, const cv::Point &, const cv::Scalar &);
    ...
    private:
        ...
        const cv::Point LINE_1_DEST{ BASE_POINT.at(1) - cv::Point{BEZIER_LENGTH, BEZIER_LENGTH}};
        void draw_line_1();
        ...
        const cv::Point LINE_3_DEST{ BASE_POINT.at(3) + cv::Point(-BEZIER_LENGTH, BEZIER_LENGTH)};
        ...
        void draw_text_stage_number_1(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_stage_number_2(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_time_1(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_time_2(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_strength_1(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_strength_2(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_strength_3(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_strength_4(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_HP_1(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_HP_2(const std::shared_ptr<message_writer_for_thread> &);
        void draw_text_HP_3(const std::shared_ptr<message_writer_for_thread> &);
    ...
    private:
        ...
        const DWORD LETTER_COLOR{
            D3DCOLOR_ARGB(static_cast<int>(BASIC_COLOR[3]),
                          ...
                          static_cast<int>(BASIC_COLOR[1]),
                          static_cast<int>(BASIC_COLOR[0]))};
        const cv::Point CENTER{HP_info::TEXTURE_SIZE.width / 2, HP_info::TEXTURE_SIZE.height / 2};
        const int LINE_THICKNESS{2};
        const int BEZIER_LENGTH{20};
        const std::vector<cv::Point> BASE_POINT{
            {CENTER},
